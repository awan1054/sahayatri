...
function Banner() {
  return (
    <>
     {/* <div className=" max-w-screen-2xl container mx-auto md:px-20 px-4 flex  md:flex-row my-10 justify-between"> */}
     <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10 gap-40">
        <div className=' order-2 w-full md:order-1 md:w-1/2 mt-12 md:mt-32 '> 
        <div className='space-y-12'>
        <h1 className='text-4xl font-bold'> Hello!!,wellcome to bike rental system</h1>
  ...
  <input type="text" className="grow" placeholder="Email" />
        ...
        <img src={dominar} className='md:w-[460px] md:h-[460px] md:ml-12' alt="" />
        </div>
        </div> 
    </>
  )
